...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'ratings' => \App\Rating\Infrastructure\GraphQL\Queries\RatingsQuery::class
            ],
            'mutation' => [
                'createRating' => \App\Rating\Infrastructure\GraphQL\Mutations\CreateRatingMutation::class
            ],
            'types' => [
                'Rating' => \App\Rating\Infrastructure\GraphQL\Types\RatingType::class
            ],
